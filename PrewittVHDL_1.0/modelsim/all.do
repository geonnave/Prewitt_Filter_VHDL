...
vcom -reportprogress 300 -work work ../vhdl/ConvolutionHV.vhd ../vhdl/Saturator.vhd ../vhdl/SelectAC.vhd ../vhdl/ConvolutionN.vhd ../vhdl/MAC_signed.vhd ../vhdl/MemImgROM.vhd ../vhdl/MainController.vhd
